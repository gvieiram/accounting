...
export function HeroSection() {
	...
	return (
		<section className="mx-auto w-full max-w-5xl">
			...
			>
				<div className="-top-14 -z-10 absolute inset-0 isolate bg-[radial-gradient(35%_80%_at_49%_0%,--theme(--color-foreground/.08),transparent)] contain-strict" />
			</div>
			...
			<div className="relative flex flex-col items-center justify-center gap-5 pt-32 pb-30">
				<div
					aria-hidden="true"
					className="-z-1 absolute inset-0 size-full overflow-hidden"
				>
